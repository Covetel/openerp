    ...
    <head>
        ...
        <script type="text/javascript">
            $(function() {
                ...
                if(document.domain=="openerp.covetel.com.ve"){
                    console.log("definiendo logo de covetel")
                    setTimeout(function(){ $('.oe_login_logo img').attr('src', '').attr('src', "http://www.covetel.com.ve/images/covetel_logo2.png");   },1000);
                }

                if(document.domain=="cantv.covetel.com.ve"){
                    setTimeout(function(){ $('.oe_login_logo img').attr('src', '').attr('src', "http://carlosguerrero.com/files/cantv_transparente.png");   },1000);
                }
            });
